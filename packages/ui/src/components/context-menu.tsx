    ...
    <ContextMenuPortal>
      ...
      >
        <BaseContextMenu.Popup
          ...
          className={cn(
            'bg-background text-text data-open:animate-in data-open:fade-in-0 data-open:zoom-in-95 data-closed:animate-out data-closed:fade-out-0 data-closed:zoom-out-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 z-50 min-w-[12rem] origin-[var(--transform-origin)] overflow-hidden rounded-md border border-border p-1 shadow-md outline-none',
            className
          )}
          {...props}
        />
...
function ContextMenuCheckboxItem({
  ...
  return (
    <BaseContextMenu.CheckboxItem
      ...
      className={cn(
        "hover:bg-button/80 focus:bg-button/80 relative flex cursor-default items-center gap-2 rounded-sm py-1.5 pr-2 pl-8 text-sm outline-hidden select-none data-[disabled]:pointer-events-none data-[disabled]:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
        className
      )}
      checked={checked}
      {...props}
...
function ContextMenuSubTrigger({
  ...
  return (
    <BaseContextMenu.SubmenuTrigger
      ...
      data-inset={inset}
      className={cn(
        'hover:bg-button/80 focus:bg-button/80 data-popup-open:bg-button/80 flex cursor-default items-center rounded-sm px-2 py-1.5 text-sm outline-hidden select-none data-[inset]:pl-8',
        className
      )}
      {...props}
    >
    ...
    <ContextMenuPortal>
      ...
      >
        <BaseContextMenu.Popup
          ...
          className={cn(
            'bg-background text-text data-open:animate-in data-open:fade-in-0 data-open:zoom-in-95 data-closed:animate-out data-closed:fade-out-0 data-closed:zoom-out-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 z-50 min-w-[12rem] origin-[var(--transform-origin)] overflow-hidden rounded-md border border-border p-1 shadow-md',
            className
          )}
          {...props}
        />
